...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test "should create policy" do
    assert_difference('Policy.count') do
      post :create, policy: { carrier: @policy.carrier, commission: @policy.commission, kind: @policy.kind, name: @policy.name }
    end
  ...
  test "should update policy" do
    patch :update, id: @policy, policy: { carrier: @policy.carrier, commission: @policy.commission, kind: @policy.kind, name: @policy.name }
    assert_redirected_to policy_path(assigns(:policy))
  end
