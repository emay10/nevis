...
class CommissionsControllerTest < ActionController::TestCase
  ...
  test "should create commission" do
    assert_difference('Commission.count') do
      post :create, commission: { amount: @commission.amount, client_id: @commission.client_id, policy_id: @commission.policy_id, user_id: @commission.user_id }
    end
  ...
  test "should update commission" do
    patch :update, id: @commission, commission: { amount: @commission.amount, client_id: @commission.client_id, policy_id: @commission.policy_id, user_id: @commission.user_id }
    assert_redirected_to commission_path(assigns(:commission))
  end
